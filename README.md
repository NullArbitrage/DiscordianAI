...
For long-running deployments, a systemd template unit is included in `contrib/systemd/` with auto-restart on crash. See [docs/Daemon.md](docs/Daemon.md) for both cron and systemd setup.
